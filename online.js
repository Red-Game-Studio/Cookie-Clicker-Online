...
var p = () => {Game.Prompt("<b>Cookie Clicker Online by RedBigz</b><hr><br><table><tr><th>Join ID</th><th>Name</th></tr><tr><td><input id=\'cco_join\'></td><td><input id='cco_name'></td></tr></table>", [["Join", ""]]); setTimeout(() => document.querySelector("#promptOption0").onclick = () => {document.querySelector("#promptOption0").onclick = null; cco()}, 1000)};
